...
class PerformanceMetricsTest:
    ...
    def __init__(self):
        ...
        self.retriever = VehicleRetriever(
            self.embedding_model, self.vector_store, similarity_threshold=0.3, price_tolerance=0.2
        )
    ...
    def test_retrieval_performance(self) -> Dict[str, Any]:
        ...
        for query_text in self.test_queries:
            ...
            if result.search_response and result.search_response.results:
                ...
                avg_score = sum(
                    r.score.semantic_score for r in result.search_response.results
                ) / len(result.search_response.results)
        ...
        self.logger.info("✅ 检索性能测试完成")
        return results

    def test_concurrent_performance(
        self, num_threads: int = 5, queries_per_thread: int = 10
    ) -> Dict[str, Any]:
        """测试并发性能"""
        self.logger.info(
            f"🧪 测试并发性能 ({num_threads} 线程, 每线程 {queries_per_thread} 查询)..."
        )
                    ...
                    thread_results.append(
                        {
                            ...
                            "result_count": len(result.search_response.results)
    ...
    def _test_supported_accuracy(self) -> Dict[str, Any]:
        ...
        supported_test_cases = [
            ...
            {"query": "SUV", "expected_category": "SUV", "description": "Basic SUV category"},
            {"query": "Sedan", "expected_category": "Sedan", "description": "Basic Sedan category"},
            {"query": "MPV", "expected_category": "MPV", "description": "Basic MPV category"},
            # Basic brand tests (supported)
            {"query": "Toyota", "expected_brand": "Toyota", "description": "Basic Toyota brand"},
            {"query": "BMW", "expected_brand": "BMW", "description": "Basic BMW brand"},
            {
                "query": "Mercedes-Benz",
                ...
                if result.search_response and result.search_response.results:
                    ...
                    # Check price tier match
                        ...
                        if expected_tier == "luxury":
                            ...
                            match = (
                                "below" in actual_price_str
                                or "10,000" in actual_price_str
                                or "20,000" in actual_price_str
                            )
                        match_type = "price"
                        if match:
                            price_matches += 1
        ...
        total_matches = (
            category_matches + brand_matches + powertrain_matches + origin_matches + price_matches
        )
        ...
        results = {
            ...
            "avg_similarity_score": statistics.mean(
                [r["similarity_score"] for r in accuracy_results]
            ),
    ...
    def _test_basic_accuracy(self) -> Dict[str, Any]:
        ...
        test_cases = [
            ...
            {"query": "MPV", "expected_category": "MPV", "description": "MPV model query"},
            {"query": "跑车", "expected_category": "Sports Car", "description": "跑车车型查询"},
            {"query": "皮卡", "expected_category": "Pickup", "description": "皮卡车型查询"},
            {"query": "敞篷车", "expected_category": "Convertible", "description": "敞篷车查询"},
            {"query": "旅行车", "expected_category": "Wagon", "description": "旅行车查询"},
            {"query": "两厢车", "expected_category": "Hatchback", "description": "两厢车查询"},
            {"query": "三厢车", "expected_category": "Sedan", "description": "三厢车查询"},
            {"query": "跨界车", "expected_category": "Crossover", "description": "跨界车查询"},
            {"query": "紧凑型", "expected_size": "紧凑型", "description": "紧凑型车查询"},
            {"query": "中型", "expected_size": "中型", "description": "中型车查询"},
            {"query": "大型", "expected_size": "大型", "description": "大型车查询"},
            {"query": "豪华型", "expected_size": "豪华型", "description": "豪华型车查询"},
            {"query": "经济型", "expected_size": "经济型", "description": "经济型车查询"},
            # 2. 品牌标签单独测试 (每个品牌单独样例)
            {"query": "奔驰", "expected_brand": "Mercedes-Benz", "description": "奔驰品牌查询"},
            {"query": "宝马", "expected_brand": "BMW", "description": "宝马品牌查询"},
            {"query": "奥迪", "expected_brand": "Audi", "description": "奥迪品牌查询"},
            {"query": "保时捷", "expected_brand": "Porsche", "description": "保时捷品牌查询"},
            {"query": "大众", "expected_brand": "Volkswagen", "description": "大众品牌查询"},
            {"query": "丰田", "expected_brand": "Toyota", "description": "丰田品牌查询"},
            {"query": "本田", "expected_brand": "Honda", "description": "本田品牌查询"},
            {"query": "日产", "expected_brand": "Nissan", "description": "日产品牌查询"},
            {"query": "雷克萨斯", "expected_brand": "Lexus", "description": "雷克萨斯品牌查询"},
            {"query": "英菲尼迪", "expected_brand": "Infiniti", "description": "英菲尼迪品牌查询"},
            {"query": "马自达", "expected_brand": "Mazda", "description": "马自达品牌查询"},
            {"query": "福特", "expected_brand": "Ford", "description": "福特品牌查询"},
            {"query": "雪佛兰", "expected_brand": "Chevrolet", "description": "雪佛兰品牌查询"},
            {"query": "凯迪拉克", "expected_brand": "Cadillac", "description": "凯迪拉克品牌查询"},
            {"query": "别克", "expected_brand": "Buick", "description": "别克品牌查询"},
            {"query": "特斯拉", "expected_brand": "Tesla", "description": "特斯拉品牌查询"},
            {"query": "Jeep", "expected_brand": "Jeep", "description": "Jeep品牌查询"},
            {"query": "比亚迪", "expected_brand": "BYD", "description": "比亚迪品牌查询"},
            {"query": "蔚来", "expected_brand": "NIO", "description": "蔚来品牌查询"},
            {"query": "小鹏", "expected_brand": "XPeng", "description": "小鹏品牌查询"},
            {"query": "理想", "expected_brand": "Li Auto", "description": "理想品牌查询"},
            {"query": "吉利", "expected_brand": "Geely", "description": "吉利品牌查询"},
            {"query": "长城", "expected_brand": "Great Wall", "description": "长城品牌查询"},
            {"query": "哈弗", "expected_brand": "Haval", "description": "哈弗品牌查询"},
            {"query": "红旗", "expected_brand": "Hongqi", "description": "红旗品牌查询"},
            {"query": "长安", "expected_brand": "Changan", "description": "长安品牌查询"},
            {"query": "奇瑞", "expected_brand": "Chery", "description": "奇瑞品牌查询"},
            {"query": "沃尔沃", "expected_brand": "Volvo", "description": "沃尔沃品牌查询"},
            {"query": "捷豹", "expected_brand": "Jaguar", "description": "捷豹品牌查询"},
            {"query": "路虎", "expected_brand": "Land Rover", "description": "路虎品牌查询"},
            {"query": "现代", "expected_brand": "Hyundai", "description": "现代品牌查询"},
            {"query": "起亚", "expected_brand": "Kia", "description": "起亚品牌查询"},
            # 3. 价格区间测试 (每个价格区间单独样例)
            {"query": "3万以下", "expected_price_range": (0, 40000), "description": "超低价位查询"},
            {"query": "5万以下", "expected_price_range": (0, 60000), "description": "超低价位查询"},
            {
                "query": "8万左右",
            ...
            # 4. 动力类型测试 (每个动力类型单独样例)
            {"query": "汽油车", "expected_powertrain": "Gasoline", "description": "汽油车查询"},
            {"query": "柴油车", "expected_powertrain": "Diesel", "description": "柴油车查询"},
            {"query": "自然吸气", "expected_powertrain": "Gasoline", "description": "自然吸气查询"},
            {"query": "涡轮增压", "expected_powertrain": "Gasoline", "description": "涡轮增压查询"},
            {"query": "机械增压", "expected_powertrain": "Gasoline", "description": "机械增压查询"},
            {"query": "纯电动", "expected_powertrain": "Electric", "description": "纯电动查询"},
            {"query": "插电混动", "expected_powertrain": "Hybrid", "description": "插电混动查询"},
            {"query": "增程式", "expected_powertrain": "Hybrid", "description": "增程式查询"},
            {"query": "油电混动", "expected_powertrain": "Hybrid", "description": "油电混动查询"},
            {
                "query": "氢燃料电池",
                "expected_powertrain": "Hydrogen",
                "description": "氢燃料电池查询",
            },
            {"query": "甲醇汽车", "expected_powertrain": "Methanol", "description": "甲醇汽车查询"},
            {"query": "天然气", "expected_powertrain": "Natural Gas", "description": "天然气查询"},
            {"query": "双燃料", "expected_powertrain": "Dual Fuel", "description": "双燃料查询"},
            {"query": "清洁能源", "expected_powertrain": "Electric", "description": "清洁能源查询"},
            # 5. 使用场景测试 (每个场景单独样例)
            {"query": "城市通勤", "expected_usage": "城市通勤", "description": "城市通勤查询"},
            {"query": "家用代步", "expected_usage": "家用", "description": "家用代步查询"},
            {"query": "周末出游", "expected_usage": "出游", "description": "周末出游查询"},
            {"query": "购物买菜", "expected_usage": "家用", "description": "购物买菜查询"},
            {"query": "接送孩子", "expected_usage": "家用", "description": "接送孩子查询"},
            {"query": "商务接待", "expected_usage": "商务", "description": "商务接待查询"},
            {"query": "公务用车", "expected_usage": "商务", "description": "公务用车查询"},
            {"query": "客户接送", "expected_usage": "商务", "description": "客户接送查询"},
            {"query": "会议用车", "expected_usage": "商务", "description": "会议用车查询"},
            {"query": "展示用车", "expected_usage": "商务", "description": "展示用车查询"},
            {"query": "网约车运营", "expected_usage": "运营", "description": "网约车运营查询"},
            {"query": "出租车", "expected_usage": "运营", "description": "出租车查询"},
            {"query": "教练车", "expected_usage": "培训", "description": "教练车查询"},
            {"query": "租赁用车", "expected_usage": "租赁", "description": "租赁用车查询"},
            {"query": "企业福利", "expected_usage": "企业", "description": "企业福利查询"},
            {"query": "自驾游", "expected_usage": "自驾游", "description": "自驾游查询"},
            {"query": "越野探险", "expected_usage": "越野", "description": "越野探险查询"},
            {"query": "露营装备", "expected_usage": "露营", "description": "露营装备查询"},
            {"query": "钓鱼用车", "expected_usage": "钓鱼", "description": "钓鱼用车查询"},
            {"query": "登山用车", "expected_usage": "登山", "description": "登山用车查询"},
            {"query": "新手司机", "expected_usage": "新手", "description": "新手司机查询"},
            {"query": "老年人用车", "expected_usage": "老年人", "description": "老年人用车查询"},
            {"query": "女性专用", "expected_usage": "女性", "description": "女性专用查询"},
            {"query": "残疾人用车", "expected_usage": "残疾人", "description": "残疾人用车查询"},
            {"query": "儿童安全", "expected_usage": "儿童", "description": "儿童安全查询"},
            # 6. 配置特征测试 (每个配置单独样例)
            # 安全配置
            {"query": "ABS防抱死", "expected_feature": "ABS", "description": "ABS防抱死查询"},
            {"query": "ESP车身稳定", "expected_feature": "ESP", "description": "ESP车身稳定查询"},
            {"query": "安全气囊", "expected_feature": "气囊", "description": "安全气囊查询"},
            {"query": "胎压监测", "expected_feature": "胎压", "description": "胎压监测查询"},
            {"query": "倒车雷达", "expected_feature": "雷达", "description": "倒车雷达查询"},
            {"query": "全景影像", "expected_feature": "影像", "description": "全景影像查询"},
            {"query": "自动泊车", "expected_feature": "泊车", "description": "自动泊车查询"},
            {"query": "盲点监测", "expected_feature": "盲点", "description": "盲点监测查询"},
            {
                "query": "车道偏离预警",
                "expected_feature": "车道",
                "description": "车道偏离预警查询",
            },
            {"query": "自适应巡航", "expected_feature": "巡航", "description": "自适应巡航查询"},
            # 舒适配置
            {"query": "座椅加热", "expected_feature": "加热", "description": "座椅加热查询"},
            {"query": "座椅通风", "expected_feature": "通风", "description": "座椅通风查询"},
            {"query": "座椅按摩", "expected_feature": "按摩", "description": "座椅按摩查询"},
            {"query": "电动座椅", "expected_feature": "电动座椅", "description": "电动座椅查询"},
            {"query": "记忆座椅", "expected_feature": "记忆座椅", "description": "记忆座椅查询"},
            {"query": "真皮座椅", "expected_feature": "真皮", "description": "真皮座椅查询"},
            {"query": "全景天窗", "expected_feature": "天窗", "description": "全景天窗查询"},
            {"query": "电动尾门", "expected_feature": "电动尾门", "description": "电动尾门查询"},
            {"query": "无钥匙进入", "expected_feature": "无钥匙", "description": "无钥匙进入查询"},
            {"query": "一键启动", "expected_feature": "一键启动", "description": "一键启动查询"},
            {"query": "自动空调", "expected_feature": "自动空调", "description": "自动空调查询"},
            # 科技配置
            {"query": "中控大屏", "expected_feature": "大屏", "description": "中控大屏查询"},
            {"query": "导航系统", "expected_feature": "导航", "description": "导航系统查询"},
            {"query": "蓝牙连接", "expected_feature": "蓝牙", "description": "蓝牙连接查询"},
            {"query": "CarPlay", "expected_feature": "CarPlay", "description": "CarPlay查询"},
            {"query": "语音控制", "expected_feature": "语音", "description": "语音控制查询"},
            {"query": "HUD抬头显示", "expected_feature": "HUD", "description": "HUD抬头显示查询"},
            {
                "query": "数字仪表盘",
                "expected_feature": "数字仪表",
                "description": "数字仪表盘查询",
            },
            {"query": "无线充电", "expected_feature": "无线充电", "description": "无线充电查询"},
            {"query": "氛围灯", "expected_feature": "氛围灯", "description": "氛围灯查询"},
            {"query": "高级音响", "expected_feature": "音响", "description": "高级音响查询"},
            # 性能配置
            {"query": "涡轮增压", "expected_feature": "涡轮", "description": "涡轮增压查询"},
            {"query": "四驱系统", "expected_feature": "四驱", "description": "四驱系统查询"},
            {"query": "运动模式", "expected_feature": "运动模式", "description": "运动模式查询"},
            {"query": "换挡拨片", "expected_feature": "换挡拨片", "description": "换挡拨片查询"},
            {"query": "运动座椅", "expected_feature": "运动座椅", "description": "运动座椅查询"},
            {"query": "大尺寸轮毂", "expected_feature": "轮毂", "description": "大尺寸轮毂查询"},
            {"query": "性能轮胎", "expected_feature": "轮胎", "description": "性能轮胎查询"},
            {"query": "刹车系统", "expected_feature": "刹车", "description": "刹车系统查询"},
            {"query": "悬挂系统", "expected_feature": "悬挂", "description": "悬挂系统查询"},
            {"query": "排气声浪", "expected_feature": "排气", "description": "排气声浪查询"},
            # 7. 具体车型测试
            {"query": "汉兰达", "expected_model": "Highlander", "description": "汉兰达查询"},
            {"query": "Model 3", "expected_model": "Model 3", "description": "特斯拉Model 3查询"},
            {"query": "雅阁", "expected_model": "Accord", "description": "本田雅阁查询"},
            {"query": "凯美瑞", "expected_model": "Camry", "description": "丰田凯美瑞查询"},
            {"query": "途观", "expected_model": "Tiguan", "description": "大众途观查询"},
            {"query": "CR-V", "expected_model": "CR-V", "description": "本田CR-V查询"},
            {"query": "RAV4", "expected_model": "RAV4", "description": "丰田RAV4查询"},
            {"query": "X3", "expected_model": "X3", "description": "宝马X3查询"},
            {"query": "GLC", "expected_model": "GLC", "description": "奔驰GLC查询"},
            {"query": "Q5", "expected_model": "Q5", "description": "奥迪Q5查询"},
            # 8. 复合查询测试
            {
                "query": "豪华SUV",
            ...
            # 9. 边界情况测试
            {"query": "那个车比较好", "description": "模糊查询测试"},
            {"query": "推荐个车", "description": "模糊查询测试"},
            {"query": "买车选什么", "description": "模糊查询测试"},
            {"query": "哪个牌子车好", "description": "模糊查询测试"},
        ]
            ...
            if result.search_response and result.search_response.results:
                ...
                if "expected_category" in test_case:
                    ...
                    if isinstance(expected, str):
                        ...
                        category_match = (expected_lower in category_lower) or (
                            category_lower in expected_lower
                        )
                ...
                if "expected_brand" in test_case:
                    ...
                    if isinstance(expected, list):
                        ...
                        brand_match = any(
                            ...
                            or brand.lower() in expected_brand.lower()
                        ...
                        brand_match = (expected_lower in brand_lower) or (
                            brand_lower in expected_lower
                        )
                ...
                if "expected_powertrain" in test_case:
                    ...
                    powertrain_match = (
                        expected_lower in powertrain_lower
                        or powertrain_lower in expected_lower
                        or powertrain_mappings.get(expected_lower, "") == powertrain_lower
                        or powertrain_lower == powertrain_mappings.get(expected_lower, "")
                    )
                ...
                if "expected_powertrain" in test_case:
                    powertrain = vehicle.precise_labels.powertrain_type or ""
                    powertrain_match = (
                        test_case["expected_powertrain"].lower() in powertrain.lower()
                    )
                ...
                if "expected_seats" in test_case:
                    ...
                    seats_match = any(
                        str(test_case["expected_seats"]) in seat_layout
                        or re.search(rf"{test_case['expected_seats']}[座席]", seat_layout)
                ...
                if "expected_transmission" in test_case:
                    ...
                    if test_case["expected_transmission"] == "Automatic":
                        transmission_match = any(
                            term in search_text for term in ["自动", "automatic", "at"]
                        )
                    else:
                        transmission_match = (
                            test_case["expected_transmission"].lower() in search_text
                        )
                ...
                accuracy_results.append(
                    {
                        ...
                        "found_results": len(result.search_response.results)
                        if result.search_response
                        else 0,
                    }
                )
        ...
        # 基础准确率
        category_accuracy = (
            sum(1 for r in accuracy_results if r.get("category_match", False)) / total_tests * 100
        )
        brand_accuracy = (
            sum(1 for r in accuracy_results if r.get("brand_match", False)) / total_tests * 100
        )
        price_accuracy = (
            sum(1 for r in accuracy_results if r.get("price_match", False)) / total_tests * 100
        )
        powertrain_accuracy = (
            sum(1 for r in accuracy_results if r.get("powertrain_match", False)) / total_tests * 100
        )

        # 扩展准确率
        usage_accuracy = (
            sum(1 for r in accuracy_results if r.get("usage_match", False)) / total_tests * 100
        )
        size_accuracy = (
            sum(1 for r in accuracy_results if r.get("size_match", False)) / total_tests * 100
        )
        model_accuracy = (
            sum(1 for r in accuracy_results if r.get("model_match", False)) / total_tests * 100
        )
        seats_accuracy = (
            sum(1 for r in accuracy_results if r.get("seats_match", False)) / total_tests * 100
        )
        drive_accuracy = (
            sum(1 for r in accuracy_results if r.get("drive_match", False)) / total_tests * 100
        )
        transmission_accuracy = (
            sum(1 for r in accuracy_results if r.get("transmission_match", False))
            / total_tests
            * 100
        )
        feature_accuracy = (
            sum(1 for r in accuracy_results if r.get("feature_match", False)) / total_tests * 100
        )
    ...
    def _test_advanced_retrieval_accuracy(self) -> Dict[str, Any]:
        ...
        advanced_test_cases = {
            ...
            "range": [
                ...
                {
                    "query": "30,000 to 50,000",
                    "expected_price_min": 30000,
                    "expected_price_max": 50000,
                },
            ...
            "exclusion": [
                {
                    "query": "SUV but not Toyota",
                    "include_category": "SUV",
                    "exclude_brand": "Toyota",
                },
                {
                    "query": "Electric car under 30,000",
                    "include_powertrain": "electric",
                    "exclude_price_above": 30000,
                },
                {
                    "query": "Luxury brand not SUV",
                    "include_brand_tier": "luxury",
                    "exclude_category": "SUV",
                },
                {
                    "query": "Sedan but not Mercedes",
                    "include_category": "Sedan",
                    "exclude_brand": "Mercedes",
                },
                {
                    "query": "German car but not BMW",
                    "include_brand_origin": "german",
                    "exclude_brand": "BMW",
                },
                {
                    "query": "Electric but not Tesla",
                    "include_powertrain": "electric",
                    "exclude_brand": "Tesla",
                },
                {
                    "query": "SUV under 50,000",
                    "include_category": "SUV",
                    "exclude_price_above": 50000,
                },
                {
                    "query": "Luxury sedan not electric",
                    "include_brand_tier": "luxury",
                    "include_category": "Sedan",
                    "exclude_powertrain": "electric",
                },
                {
                    "query": "Family car but not minivan",
                    "include_usage": "family",
                    "exclude_category": "MPV",
                },
                {
                    "query": "Performance car but not gasoline",
                    "include_performance": "high",
                    "exclude_powertrain": "gasoline",
                },
            ],
            "complex": [
                {
                    "query": "Luxury electric SUV under 80,000",
                    "include_brand_tier": "luxury",
                    "include_powertrain": "electric",
                    "include_category": "SUV",
                    "exclude_price_above": 80000,
                },
                {
                    "query": "German brand sedan",
                    "include_brand_origin": "german",
                    "include_category": "Sedan",
                },
                {
                    "query": "7 seats family SUV under 60,000",
                    "include_seats": 7,
                    "include_usage": "family",
                    "include_category": "SUV",
                    "exclude_price_above": 60000,
                },
                {
                    "query": "Electric luxury sedan with autopilot",
                    "include_powertrain": "electric",
                    "include_brand_tier": "luxury",
                    "include_category": "Sedan",
                    "include_feature": "autopilot",
                },
                {
                    "query": "Compact electric car under 40,000",
                    "include_size": "compact",
                    "include_powertrain": "electric",
                    "exclude_price_above": 40000,
                },
                {
                    "query": "High performance SUV not electric",
                    "include_performance": "high",
                    "include_category": "SUV",
                    "exclude_powertrain": "electric",
                },
                {
                    "query": "Business sedan luxury brand",
                    "include_usage": "business",
                    "include_category": "Sedan",
                    "include_brand_tier": "luxury",
                },
                {
                    "query": "Off-road vehicle 4x4",
                    "include_usage": "off-road",
                    "include_drive": "4x4",
                },
                {
                    "query": "City car compact gasoline",
                    "include_usage": "city",
                    "include_size": "compact",
                    "include_powertrain": "gasoline",
                },
                {
                    "query": "Family MPV 7 seats affordable",
                    "include_usage": "family",
                    "include_category": "MPV",
                    "include_seats": 7,
                    "include_price_alias": "economy",
                },
            ],
        }
        ...
        advanced_results["advanced_total_accuracy"] = (
            (total_matches / total_tests * 100) if total_tests > 0 else 0
        )

        self.logger.info(
            f"Advanced retrieval accuracy: {advanced_results['advanced_total_accuracy']:.1f}%"
        )
    ...
    def _check_exclusion_match(self, test_case, result) -> bool:
        ...
        if "exclude_brand" in test_case:
            ...
            excluded_found = any(
                exclude_brand in r.vehicle.precise_labels.brand.lower() for r in all_results
            )
            if excluded_found:
        ...
        if "exclude_category" in test_case:
            ...
            excluded_found = any(
                exclude_category in r.vehicle.precise_labels.vehicle_category_bottom.lower()
        ...
        if "exclude_price_above" in test_case:
            ...
            expensive_found = any(
                self._extract_price_from_range(r.vehicle.precise_labels.prize or "")
                and self._extract_price_from_range(r.vehicle.precise_labels.prize or "") > max_price
                for r in all_results
            )
            if expensive_found:
        ...
        if inclusion_conditions:
            ...
            for r in all_results:
                ...
                if "include_category" in test_case:
                    ...
                    if not (
                        include_category in r.vehicle.precise_labels.vehicle_category_bottom.lower()
                        or r.vehicle.precise_labels.vehicle_category_bottom.lower()
                        in include_category
                    ):
                ...
                if "include_brand" in test_case:
                    ...
                    if not (
                        include_brand in r.vehicle.precise_labels.brand.lower()
                        or r.vehicle.precise_labels.brand.lower() in include_brand
                    ):
                        inclusion_match = False
                ...
                if "include_powertrain" in test_case:
                    ...
                    mapped_powertrain = powertrain_mappings.get(
                        include_powertrain, include_powertrain
                    )

                    if not (
                        mapped_powertrain in actual_powertrain
                        or actual_powertrain in mapped_powertrain
                    ):
                        inclusion_match = False
    ...
    def _check_complex_match(self, test_case, result) -> bool:
        ...
        # Combine all checks
        hierarchical_match = self._check_hierarchical_match(
            test_case,
            result.search_response.results[0].vehicle
            if result.search_response and result.search_response.results
            else None,
        )
        range_match = self._check_range_match(
            test_case,
            result.search_response.results[0].vehicle
            if result.search_response and result.search_response.results
            else None,
    ...
    def run_all_tests(self) -> Dict[str, Any]:
        ...
        accuracy_results = self._combine_accuracy_results(
            results["accuracy_metrics"], results["advanced_retrieval_accuracy"]
        )
        ...
        self.logger.info(
            f"Complete performance test suite finished in {results['test_suite_duration']:.2f}s"
        )
