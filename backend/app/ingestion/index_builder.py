...
from backend.app.config import CHROMA_COLLECTION_NAME, CHROMA_PERSIST_DIR, EMBEDDING_MODEL
from backend.app.ingestion.toml_parser import parse_all_vehicles
...
def build_vehicle_index(
    ...
    """
    from backend.app.config import VEHICLE_DATA_DIR
