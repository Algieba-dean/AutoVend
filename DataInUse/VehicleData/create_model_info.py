            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": f"I need detailed comments for the following attributes of the {model_name} car model.\n\n"
                               ...
                               f"Example: prize_comments = \"The actual price of the {model_name} starts at $56,900 USD for the base trim, rising to $82,500 USD for the top trim with all options.\"\n"
                               f"IMPORTANT: For the prize field, ALWAYS use USD (US dollars) as the currency unit in the comments.\n"
            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": f"Create a detailed specification file for the {model_name} car model. "
                               ...
                               f"5. For the prize field, make sure to use USD (US dollars) as the currency unit. Example: \"200,000-300,000\" means $200,000-$300,000 USD.\n"
                               f"6. For EVERY attribute, add a corresponding _comments field with specific details.\n"
                               ...
                               f"   For the prize field, include the exact price range in USD in the comments. Example: prize_comments = \"The {model_name} is priced between $45,000 and $65,000 USD depending on the trim level and options.\"\n"
                               f"7. For range values (like trunk_volume), select the appropriate range AND add a comment with the exact value.\n"
                               ...
                               f"8. ALWAYS use ACTUAL, FACTUAL data based on the real {model_name}.\n"
                               f"9. Include detailed comments for EVERY attribute, especially vehicle features and performance metrics.\n"
                               f"10. Use proper TOML syntax with quotes around string values.\n"
                               f"11. STRICTLY follow the template structure. DO NOT add any sections, explanations, or content that is not part of the template.\n"
                               f"12. IMPORTANT: EVERY attribute must have a corresponding _comments field that explains it in detail.\n"
                               f"13. CRITICAL INSTRUCTION ABOUT POWERTRAIN TYPE:\n"
