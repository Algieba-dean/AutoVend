...
from backend.app.ingestion.index_builder import (
    build_index,
    build_vehicle_index,
    get_chroma_client,
    get_chroma_vector_store,
)
from backend.app.rag.vehicle_index import get_vehicle_index, reset_vehicle_index
...
class TestVehicleIndexManager:
    ...
    def test_reset_clears_cache(self):
        ...
        from backend.app.rag.vehicle_index import _vehicle_index
    ...
    def test_get_raises_on_empty_collection(self, tmp_path):
        ...
        with patch("backend.app.rag.vehicle_index.get_chroma_client") as mock_client_fn:
            ...
            with patch("backend.app.rag.vehicle_index.get_chroma_vector_store") as mock_store_fn:
