...
from backend.app.routes.chat import set_agent
...
def agent():
    ...
    from backend.app.main import _startup_status
...
class TestProfileAPI:
    ...
    async def test_create_profile(self, client, tmp_path, monkeypatch):
        monkeypatch.setattr("backend.app.models.storage.PROFILES_DIR", tmp_path)
...
class TestTestDriveAPI:
    ...
    async def test_create_test_drive(self, client, tmp_path, monkeypatch):
        monkeypatch.setattr("backend.app.models.storage.TEST_DRIVES_DIR", tmp_path)
